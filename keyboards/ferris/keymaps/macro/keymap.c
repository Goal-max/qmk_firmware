...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_split_3x5_2(MS_ACL0, MS_BTN2, MS_ACL2, MS_BTN1, KC_TRNS, KC_TRNS, MS_BTN1, ADD_BAR, MS_BTN2, KC_TRNS, KC_LGUI, KC_LALT, KC_LCTL, MS_ACL1, NEW_TAB, CLOSE_TAB, MS_LEFT, MS_DOWN, MS_UP, MS_RGHT, KC_HOME, KC_PGUP, KC_PGDN, KC_END, KC_TRNS, KC_TRNS, MS_WHLL, PREV_TAB, SWITCH_TAB, MS_WHLR, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
    ...
    [4] = LAYOUT_split_3x5_2(KC_NO, KC_W, KC_NO, KC_P, KC_B, KC_NO, KC_NO, KC_NO, KC_Y, KC_NO, LGUI_T(KC_7), LALT_T(KC_5), LCTL_T(KC_3), LSFT_T(KC_1), CAPG, KC_NO, RSFT_T(KC_2), RCTL_T(KC_4), RALT_T(KC_6), RGUI_T(KC_8), KC_PERC, KC_NO, KC_ASTR, KC_9, KC_NO, KC_SLSH, KC_0, KC_COMM, KC_DOT, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_NO),
